...
interface SetTokenInterface extends Interface {
  functions: {
    ...
    locker: TypedFunctionDescription<{ encode([]: []): string }>;
    ...
    moduleStates: TypedFunctionDescription<{ encode([]: [string]): string }>;
  ...
  events: {
    ...
    ExternalPositionDataEdited: TypedEventDescription<{
      encodeTopics([_component, _positionModule, _data]: [
        string | null,
        string | null,
        null
      ]): string[];
    ...
    ExternalPositionUnitEdited: TypedEventDescription<{
      encodeTopics([_component, _positionModule, _realUnit]: [
        string | null,
        string | null,
        null
      ]): string[];
    ...
    Invoked: TypedEventDescription<{
      encodeTopics([_target, _value, _data, _returnValue]: [
        string | null,
        BigNumberish | null,
        null,
        null
    ...
    PositionModuleAdded: TypedEventDescription<{
      encodeTopics([_component, _positionModule]: [
        string | null,
        string | null
      ]): string[];
    }>;
